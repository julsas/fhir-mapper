...
def transform_immunization_3to4(json_data):
    ...
    if vaccination_protocol == None:
        ...
        for protocol in vaccination_protocol:
            protocol_applied = ImmunizationProtocolApplied.parse_obj(protocol_example)
            ...
            if dose_sequence == None:
                ...
                #data_absent_reason_ex = FHIRPrimitiveExtension.parse_obj(data_absent_reason)
                #protocol_applied.doseNumberPositiveInt = None
                protocol_applied.doseNumberPositiveInt__ext = data_absent_reason
            else:
